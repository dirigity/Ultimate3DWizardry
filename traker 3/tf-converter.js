            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    ...
                    case 11:
                        ...
                        return [2 /*return*/ , (_b.sent())[0] ? [undefined, data.clone()] : [data.clone(), undefined]];
                    case 12:
                        {
            ...
            case 'FusedDepthwiseConv2dNative':
                {
                    ...
                    var kernelMethod = node.op === '_FusedConv2D' ?
                        tfc.fused.conv2d : tfc.fused.depthwiseConv2d;
                    return [kernelMethod({
            ...
            case 'MaxPoolWithArgmax':
                {
                    ...
                    var _c = tfc.maxPoolWithArgmax(getParamValue('x', node, tensorMap, context), [kernelSize[1], kernelSize[2]], [stride[1], stride[2]], pad, includeBatchInIndex),
                        result = _c.result,
                        indexes = _c.indexes;
